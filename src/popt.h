...
POPT_LIB_EXPORT extern unsigned int _poptBitsN;		/*!< internal */
POPT_LIB_EXPORT extern  unsigned int _poptBitsM;		/*!< internal */
POPT_LIB_EXPORT extern  unsigned int _poptBitsK;		/*!< internal */
